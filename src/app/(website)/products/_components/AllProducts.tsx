...
export default function AllProducts() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 py-12 sm:py-16 md:py-20 px-4">
      <div className="container mx-auto">
        ...
        <div className="mb-6 sm:mb-8 flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-4">
          <div className="w-full sm:w-[40%] md:w-[30%] lg:w-[25%]">
            <div className="relative">
              <Input
                ...
                className="pl-10 sm:pl-12 pr-4 h-[45px] sm:h-[50px] rounded-xl sm:rounded-2xl border-slate-200 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm w-full"
              />
              <Search
          ...
          <div className="flex gap-3 sm:gap-4">
            <Select onValueChange={(value) => setCategory(value)}>
              <SelectTrigger className="w-full sm:w-[200px] md:w-[230px] !h-[45px] sm:!h-[50px]">
        ...
        {isLoading ? (
          ...
          <p className="text-center text-red-500 text-sm sm:text-base">Failed to fetch products</p>
        ) : product.length === 0 ? (
          <div className="flex justify-center items-center h-48 sm:h-64 md:h-72 lg:h-80 bg-gray-100 rounded-xl sm:rounded-2xl shadow-lg">
              ...
              return (
                ...
                >
                  <div className="relative overflow-hidden">
                    ...
                    <div
                      className={`absolute top-3 sm:top-4 left-3 sm:left-4 z-10 flex items-center justify-center h-9 w-9 sm:h-10 sm:w-10 rounded-full cursor-pointer shadow-md transition-all duration-300 ${
                        isWishlisted
                  ...
                  <div className="p-4 sm:p-5 md:p-6 space-y-3 sm:space-y-4">
                    <h3 className="text-lg sm:text-xl font-bold text-slate-800 line-clamp-2 group-hover:text-indigo-600 transition-colors">
                      {p.name}
                    </h3>
                      ...
                      {cartItem ? (
                        <div className="flex items-center gap-2 w-full sm:w-auto justify-center sm:justify-end">
                          <button
                            ...
                            className="bg-red-500 text-white px-2.5 sm:px-3 py-1.5 sm:py-1 rounded"
                          >
                            <Minus size={14} className="sm:w-4 sm:h-4" />
                          </button>
                          <span className="text-sm sm:text-base font-medium min-w-[20px] text-center">{cartItem.quantity}</span>
                          <button
                            onClick={() =>
                              updateQuantityMutation.mutate({
                                productId: p._id,
                            ...
                            className="bg-green-500 text-white px-2.5 sm:px-3 py-1.5 sm:py-1 rounded"
                          >
                        ...
                        <button
                          ...
                          className="bg-gradient-to-r from-orange-500 to-red-400 text-white px-4 sm:px-4 py-2 sm:py-2 rounded-xl sm:rounded-2xl text-xs sm:text-sm font-medium w-full sm:w-auto hover:shadow-lg transition-shadow"
                        >
                          Add to Cart
                        </button>
                      )}
