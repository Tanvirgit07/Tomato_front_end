  ...
  const renderStars = (rating: number) => {
    ...
    return (
      <div className="flex items-center text-yellow-400">
        ...
        {halfStar && (
          <Star key="half" className="w-4 h-4 sm:w-5 sm:h-5 fill-current opacity-50" />
        )}
        {Array(emptyStars)
          .fill(0)
          .map((_, i) => (
          ...
          >
            ...
            <div className="p-4 sm:p-5">
              ...
              <div className="flex justify-between items-center mt-4">
                <p className="text-orange-600 font-bold text-lg sm:text-xl">${dish.price}</p>
                <button className="bg-gradient-to-r from-orange-500 to-red-600 text-white px-4 py-2 rounded-full text-sm font-medium hover:from-orange-600 hover:to-red-700 transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105">
                  Add to Cart
                </button>
              </div>
            </div>
